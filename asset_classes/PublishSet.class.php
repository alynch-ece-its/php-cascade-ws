...
class PublishSet extends ScheduledPublishing
{
    ...
    private function processPublishableAssetIdentifiers()
    {
    	...
    	// files
    	if( $this->getProperty()->files->publishableAssetIdentifier != NULL )
    	{
    	...
    	// folders
    	if( $this->getProperty()->folders->publishableAssetIdentifier != NULL )
    	{
    	...
    	// pages
    	if( $this->getProperty()->pages->publishableAssetIdentifier != NULL )
    	{
