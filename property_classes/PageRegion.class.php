...
class PageRegion extends Property
{
	...
	public function __construct( stdClass $region, AssetOperationHandlerService $service=NULL )
	{
		$this->id              = $region->id;
		...
		if( self::DEBUG ) {	echo "PR::L26 " . "Block ID: " . $this->block_id . BR; }
	}
	...
	{
		if( self::DEBUG ) {	echo "PR::L39 " . $this->name . BR . "Block ID: " . $this->block_id . BR; }
	
		if( $this->block_id != NULL && $this->block_id != "" && $this->service != NULL )
		{
			if( self::DEBUG ) {	echo "PR::L43 " . "Type of block: " . $this->getType( $this->block_id ) . BR;
			echo "Block ID: " . $this->block_id  . BR; }
	...
	public function getFormat()
	{
		...
		{
			if( self::DEBUG ) { echo "PR::L73 " . __FUNCTION__ . BR; echo "Type of format: " . $this->getType( $this->format_id ) . BR; 	echo "Format ID: " . $this->format_id  . BR; }
	...
	{
		if( self::DEBUG) { echo "PR::L217 ID string: " . $id_string . BR; }
